  ...
  return (
    <div className='text-my-light py-10 md:w-[90%] mx-auto w-[95%]'>
      <div className='p-4 md:p-2 rounded-xl mb-10'>
        <Parallax speed={5}>
          <h1 className='text-2xl md:text-3xl font-bold md:mb-4 text-my-blue'>
      ...
      <div className=''>
        <Parallax speed={5} className='md:mb-5'>
          <h2 className='font-bold text-xl text-my-blue'>هدف از داشتن وب سایت چیست؟</h2>
        </Parallax>
        <ul className='grid lg:grid-cols-4 md:grid-cols-2 gap-6'>
          {websiteBenefits.map((item, index) => (
            <Parallax key={index} speed={20}>
              <li className='pb-10 p-5 rounded-xl shadow-2xl hover:shadow-lg transition-shadow duration-300 overflow-hidden'>
                <div className='flex text-my-blue items-start sm:items-center gap-3 mb-4'>
                  <div className='text-4xl sm:text-3xl flex-shrink-0 hover:scale-110 transition-transform duration-300'>
                    <item.icon />
                  </div>
                  <h3 className='font-bold text-lg md:text-xl hover:text-my-blue transition-colors duration-300'>
                    {item.title}
                  </h3>
                </div>
